...
Output from `gbuild` will look something like
    ...
    From https://github.com/classicbitcoins/cbitcoin
...
./bin/gbuild --commit bitcoin=${COMMIT} --url bitcoin=${URL} ../cbitcoin/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit bitcoin=${COMMIT} --url bitcoin=${URL} ../cbitcoin/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit bitcoin=${COMMIT} --url bitcoin=${URL} ../cbitcoin/contrib/gitian-descriptors/gitian-osx.yml
```
...
LXC_ARCH=amd64 LXC_SUITE=trusty on-target -u root \
  ...
  $( sed -ne '/^packages:/,/[^-] .*/ {/^- .*/{s/"//g;s/- //;p}}' ../cbitcoin/contrib/gitian-descriptors/*|sort|uniq )
...
./bin/gbuild --url bitcoin=${BTCPATH},signature=${SIGPATH} ../cbitcoin/contrib/gitian-descriptors/gitian-win-signer.yml
```
