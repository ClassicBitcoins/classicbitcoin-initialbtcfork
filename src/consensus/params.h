...
struct Params {
    ...
    int BIP66Height;
    /** Block height at which ClassicBitcoin hard fork becomes active */
    int CBTCHeight;
    /** Premining blocks for ClassicBitcoin hard fork **/
    int CBTCPremineWindow;
    bool CBTCPremineEnforceWhitelist;
