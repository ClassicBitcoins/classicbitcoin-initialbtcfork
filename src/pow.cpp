...
unsigned int GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock, const Consensus::Params& params)
{
    ...
    bool postfork = nHeight >= params.CBTCHeight;
    ...
    else if (nHeight < params.CBTCHeight + params.CBTCPremineWindow) {
        return nProofOfWorkLimit;
    }
    else if (nHeight < params.CBTCHeight + params.CBTCPremineWindow + params.nPowAveragingWindow){
...
// Deprecated for Classic Bitcoin
...
// Depricated for Classic Bitcoin
