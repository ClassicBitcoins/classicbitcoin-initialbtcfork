...
UniValue setaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("setaccount", "\"CaRWzzc9wmaxvroCVoXhnqhtRDHoRP1kgu\" \"tabby\"")
            + HelpExampleRpc("setaccount", "\"CaRWzzc9wmaxvroCVoXhnqhtRDHoRP1kgu\", \"tabby\"")
        );
...
UniValue getaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("getaccount", "\"CaRWzzc9wmaxvroCVoXhnqhtRDHoRP1kgu\"")
            + HelpExampleRpc("getaccount", "\"CaRWzzc9wmaxvroCVoXhnqhtRDHoRP1kgu\"")
        );
...
UniValue sendtoaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 8)
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("sendtoaddress", "\"CaRWzzc9wmaxvroCVoXhnqhtRDHoRP1kgu\" 0.1")
            + HelpExampleCli("sendtoaddress", "\"CaRWzzc9wmaxvroCVoXhnqhtRDHoRP1kgu\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("sendtoaddress", "\"CaRWzzc9wmaxvroCVoXhnqhtRDHoRP1kgu\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("sendtoaddress", "\"CaRWzzc9wmaxvroCVoXhnqhtRDHoRP1kgu\", 0.1, \"donation\", \"seans outpost\"")
        );
...
UniValue signmessage(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 2)
        throw std::runtime_error(
            ...
            + HelpExampleCli("signmessage", "\"CaRWzzc9wmaxvroCVoXhnqhtRDHoRP1kgu\" \"my message\"") +
            "\nVerify the signature\n"
            + HelpExampleCli("verifymessage", "\"CaRWzzc9wmaxvroCVoXhnqhtRDHoRP1kgu\" \"signature\" \"my message\"") +
            "\nAs json rpc\n"
            + HelpExampleRpc("signmessage", "\"CaRWzzc9wmaxvroCVoXhnqhtRDHoRP1kgu\", \"my message\"")
        );
...
UniValue getreceivedbyaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            + HelpExampleCli("getreceivedbyaddress", "\"CaRWzzc9wmaxvroCVoXhnqhtRDHoRP1kgu\"") +
            "\nThe amount including unconfirmed transactions, zero confirmations\n"
            + HelpExampleCli("getreceivedbyaddress", "\"CaRWzzc9wmaxvroCVoXhnqhtRDHoRP1kgu\" 0") +
            "\nThe amount with at least 6 confirmations\n"
            + HelpExampleCli("getreceivedbyaddress", "\"CaRWzzc9wmaxvroCVoXhnqhtRDHoRP1kgu\" 6") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("getreceivedbyaddress", "\"CaRWzzc9wmaxvroCVoXhnqhtRDHoRP1kgu\", 6")
       );
...
UniValue sendfrom(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 3 || request.params.size() > 6)
        throw std::runtime_error(
            ...
            + HelpExampleCli("sendfrom", "\"\" \"CaRWzzc9wmaxvroCVoXhnqhtRDHoRP1kgu\" 0.01") +
            "\nSend 0.01 from the tabby account to the given address, funds must have at least 6 confirmations\n"
            + HelpExampleCli("sendfrom", "\"tabby\" \"CaRWzzc9wmaxvroCVoXhnqhtRDHoRP1kgu\" 0.01 6 \"donation\" \"seans outpost\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendfrom", "\"tabby\", \"CaRWzzc9wmaxvroCVoXhnqhtRDHoRP1kgu\", 0.01, 6, \"donation\", \"seans outpost\"")
        );
...
UniValue sendmany(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 8)
        throw std::runtime_error(
            ...
            + HelpExampleCli("sendmany", "\"\" \"{\\\"CaRWzzc9wmaxvroCVoXhnqhtRDHoRP1kgu\\\":0.01,\\\"CaRWzzc9wmaxvroCVoXhnqhtRDHoRP1kgu\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n"
            + HelpExampleCli("sendmany", "\"\" \"{\\\"CaRWzzc9wmaxvroCVoXhnqhtRDHoRP1kgu\\\":0.01,\\\"CaRWzzc9wmaxvroCVoXhnqhtRDHoRP1kgu\\\":0.02}\" 6 \"testing\"") +
            "\nSend two amounts to two different addresses, subtract fee from amount:\n"
            + HelpExampleCli("sendmany", "\"\" \"{\\\"CaRWzzc9wmaxvroCVoXhnqhtRDHoRP1kgu\\\":0.01,\\\"CaRWzzc9wmaxvroCVoXhnqhtRDHoRP1kgu\\\":0.02}\" 1 \"\" \"[\\\"CaRWzzc9wmaxvroCVoXhnqhtRDHoRP1kgu\\\",\\\"CaRWzzc9wmaxvroCVoXhnqhtRDHoRP1kgu\\\"]\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendmany", "\"\", \"{\\\"CaRWzzc9wmaxvroCVoXhnqhtRDHoRP1kgu\\\":0.01,\\\"CaRWzzc9wmaxvroCVoXhnqhtRDHoRP1kgu\\\":0.02}\", 6, \"testing\"")
        );
...
UniValue walletlock(const JSONRPCRequest& request)
{
    ...
    if (pwallet->IsCrypted() && (request.fHelp || request.params.size() != 0)) {
        throw std::runtime_error(
            ...
            + HelpExampleCli("sendtoaddress", "\"CaRWzzc9wmaxvroCVoXhnqhtRDHoRP1kgu\" 1.0") +
...
UniValue encryptwallet(const JSONRPCRequest& request)
{
    ...
    StartShutdown();
    return "wallet encrypted; ClassicBitcoin server stopping, restart to run with encrypted wallet. The keypool has been flushed and a new HD seed was generated (if you are using HD). You need to make a new backup.";
}
