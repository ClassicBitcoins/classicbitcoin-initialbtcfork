...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-bootstrap", _("Enables Classic Bitcoin bootstrap mode. Allows CBTC client to connect to Bitcoin p2p network to download blockahin history."));
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/classicbitcoins/cbitcoin>";
    const std::string URL_WEBSITE = "<https://bitclassic.info>";
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    fCBTCBootstrapping = gArgs.GetBoolArg("-bootstrap", false);
