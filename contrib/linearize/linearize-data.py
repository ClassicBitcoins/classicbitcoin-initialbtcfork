...
""" Block header format of Classic Bitcoin.
...
def calc_hash_str(blk_hdr, cbtc_hash):
    if not cbtc_hash:
...
class BlockDataCopier:
    ...
    def run(self):
        while self.blkCountOut < len(self.blkindex):
            ...
            self.hash_str = calc_hash_str(blk_hdr, blk_height >= 516095)
